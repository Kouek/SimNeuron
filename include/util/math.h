...
namespace kouek
{
	...
	public:
		static inline glm::mat4 inverseProjective(const glm::mat4& projection)
		{
			...
			// ----+----
			// [ C | D ]
			glm::mat2 a(projection[0][0], projection[0][1],
				projection[1][0], projection[1][1]);
			glm::mat2 b(projection[2][0], projection[2][1],
				projection[3][0], projection[3][1]);
			glm::mat2 c(projection[0][2], projection[0][3],
				projection[1][2], projection[1][3]);
			glm::mat2 d(projection[2][2], projection[2][3],
			...
			// [ C'| D']
			return glm::mat4(
				a1[0][0], a1[0][1], c1[0][0], c1[0][1],
				a1[1][0], a1[1][1], c1[1][0], c1[1][1],
				b1[0][0], b1[0][1], d1[0][0], d1[0][1],
				b1[1][0], b1[1][1], d1[1][0], d1[1][1]
			);
		}
		...
		static inline void printGLMMat4(const glm::mat4& mat4, const char* name = nullptr)
		{
			if (name == nullptr)
				printf("[\n%f\t%f\t%f\t%f\n", mat4[0][0], mat4[1][0], mat4[2][0], mat4[3][0]);
			else
				printf("%s:[\n%f\t%f\t%f\t%f\n", name, mat4[0][0], mat4[1][0], mat4[2][0], mat4[3][0]);
